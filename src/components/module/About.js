...
export default function About() {
  const map = [0, 1, 2, 3];
  return (
    <div className="relative w-full  min-h-[339px] max-h-[390px] mx-auto ">
      <Image
        src={aboutImage}
        alt="About Image"
      ...
      <div className="absolute top-0 left-0 right-0 bottom-0 z-2 flex flex-col lg:flex-row justify-evenly p-4 text-neutral-white text-captionSM">
        <div className="text-neutral-white text-captionSM   ">
          <h4 className="text-overlineLG lg:text-h4">
            رستوران‌های زنجیره‌ای ترخینه
          </h4>
          <p className="text-captionMD lg:text-bodyXL text-justify">
        ...
        <div className="grid grid-cols-2 gap-x-5 gap-y-5">
          {map.map((item) => (
            ...
            >
              ...
              />
              <p className="text-captionMD lg:text-bodyLG ">
