...
export default function CardCategoriesMenu({ loading = false }) {
  ...
  return (
    <div className="mx-auto  border-1 border-neutral-gray4 rounded-4 h-[100px] overflow-hidden sm:col-span-6 md:w-full md:col-span-8 md:col-start-3 md:h-[160px] md:max-w-[600px] md:shadow-cards lg:col-span-6 ">
