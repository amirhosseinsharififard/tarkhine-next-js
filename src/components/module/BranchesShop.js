  ...
  return (
    <div className="text-center">
      ...
      <div className="relative text-neutral-gray8">
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 p-3 border border-main-primary w-[320px] lg:w-[810px] mx-auto absolute top-[-20px] lg:top-[-30px] left-0 right-0 bg-neutral-white z-20">
          <div className="col-span-2 lg:col-span-1 flex lg:flex-col order-1 lg:order-2">
            <Image src={location} alt="location"  className="lg:mx-auto ml-1  w-[16px] h-[16px] lg:w-[32px] lg:h-[32px] " />
          ...
          <div className="flex lg:flex-col order-2 lg:order-1">
            <Image src={call} alt="call" className="lg:mx-auto ml-1  w-[16px] h-[16px] lg:w-[32px] lg:h-[32px] "  />
          ...
          <div className="flex lg:flex-col order-3 lg:order-3">
            <Image src={clock} alt="clock"  className="lg:mx-auto ml-1  w-[16px] h-[16px] lg:w-[32px] lg:h-[32px] " />
            <p className="text-captionSM lg:text-bodyMD">
